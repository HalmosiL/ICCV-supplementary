...
CONFIG_MAIN["DEVICE"] = "cuda:0" 

try:
    print(CONFIG_MAIN['SAVE_FOLDER'] + "normal/")
    os.mkdir(CONFIG_MAIN['SAVE_FOLDER'] + "normal/")
...
for e, (images, labels, label) in enumerate(val_loader):
    ...
    torch.save(pred_sum_mask, CONFIG_MAIN['SAVE_FOLDER'] + "normal/prediction_" + str(e) + ".pth")
    torch.save(label[0], CONFIG_MAIN['SAVE_FOLDER'] + "normal/label_" + str(e) + ".pth")
